...
The project utilizes the Polygon network for smart contracts and IPFS as a database for uploading Item images. Additionally, DMarket employs Infura API gateway for IPFS, Next.js as its framework, Hardhat for smart contract development, Tailwind CSS for UI design, and Vercel for deployment to the internet.
